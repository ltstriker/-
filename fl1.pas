...
//  test(statbegsys+[ident], declbegsys, 7)
    ...
    begin  {列出本程序体生成的代码}
        ...
        begin
            ...
            writeln(output, i : 3, mnemonic[f] : 5, l : 3, a : 5);
        {i: 代码序号; 
            mnemonic[f]: 功能码的字符串;
            l: 相对层号(层差);
            a: 相对地址或运算号码}
    ...
    procedure  statement(fsys : symset);
        ...
        begin {expression}
            ...
            begin 
                ...
                if addop = minus then 
                    gen(opr, 0, 1) {若第一个项前是负号, 生成一条“负运算”指令}
            end else 
                term(fsys+[plus, minus]); {第一个记号不是加号或减号, 则处理一个项}
        ...
        begin {statement}
            ...
            begin  getsym; {取下一记号}
                ...
                end else if sym = ifsym then {处理条件语句}
                begin
                    getsym; {取下一记号} 
                ...
                end else if sym = beginsym then {处理语句序列}
                begin
                    getsym;  
                ...
                end else if sym = whilesym then {处理循环语句}
                begin
        ...
        repeat
            ...
            begin  
                ...
                repeat 
                    ...
                    if sym = semicolon then 
                        getsym 
                    else error(5) {如果当前记号是分号,则常数说明已处理完, 否则出错}
                until sym <> ident 
            ...
            begin  
                ...
                if sym = semicolon then 
                    ...
                    error(5); {当前记号是分号, 则取下一记号,否则,过程名后漏掉分号出错}
